  ...
  <footer className="relative z-10 border-t border-border mt-16">
    <div className="container mx-auto px-4 max-w-5xl py-12">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="font-display font-bold text-lg gradient-text">EcoLens</span>
          </div>
          <p className="text-xs text-subtle leading-relaxed max-w-xs">
            AI-powered e-waste detection that helps you sell, trade, or recycle old electronics — keeping them out of landfills.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-xs text-subtle leading-relaxed mb-4">
            Over 62 million tonnes of e-waste are generated every year. We're building tools to change that — one device at a time.
          </p>
      ...
      <div className="border-t border-border pt-6 flex flex-col sm:flex-row items-center justify-between gap-2">
        <p className="text-xs text-faintest">© {new Date().getFullYear()} EcoLens. Built to fight e-waste.</p>
        <div className="flex items-center gap-1.5">
          <Leaf className="w-3 h-3 text-primary" />
          <span className="text-xs text-subtle">Every scan counts.</span>
        </div>
      </div>
    </div>
  </footer>
